...
class Picker extends Component {
  ...
  getPopupClassName() {
    const {
      showHour, showMinute, showSecond, use12Hours, prefixCls, popupClassName
    } = this.props;
      ...
      >
        ...
        >
          <input
            ...
            id={id}
          />
          {inputIcon || <span className={`${prefixCls}-icons`}/>}
